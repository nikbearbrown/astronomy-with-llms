...
*How Dead Worlds Remember What Living Ones Forgot.*

**TL;DR:** The Moon and Mercury, small airless worlds covered in craters, preserve a history erased on Earth by active geology and erosion. By reading their scarred surfaces — counting craters, dating rocks, measuring isotopes — we learn that the early solar system experienced a heavy bombardment of giant impacts, including one that may have torn the Moon from Earth itself.
...
<!-- → [IMAGE: Apollo bootprint photograph alongside a present-day Earth footprint in soil — the contrast makes the chapter's central argument visual before a word of science has been explained; caption: "The Moon's surface has no mechanism to erase what lands on it. Earth erases everything."] -->
...
<!-- → [IMAGE: full-disk lunar photograph with the two terrain types labeled — highlands (bright, cratered, mostly far side) and major maria (dark, less cratered, near side) — annotate Mare Tranquillitatis, Mare Imbrium, and the lunar highlands; student should immediately see the cratering density difference that drives the chapter's argument] -->
...
<!-- → [CHART: cratering rate vs. time — horizontal axis from 4.5 billion years ago to present; vertical axis = relative impact flux (log scale); show the steep decline from the heavy bombardment era (~4.5 to ~3.8 Ga) to the low, roughly constant rate of the last 3.8 billion years; annotate "highlands formed here" in the high-flux region and "maria formed here" in the declining flux; student should see why the highlands have 10× the craters despite being only 200–400 million years older] -->
...
<!-- → [DIAGRAM: cross-section sequence of impact crater formation in four stages — (1) projectile penetrates 2–3× its diameter, shock wave initiates; (2) vapor cloud expands, hemispherical cavity excavates; (3) ejecta flies outward, rim forms; (4) floor rebounds into central peak, terrace structure visible on rim walls — label shock wave, ejecta blanket, central peak, raised rim, and secondary craters; annotate "crater diameter ≈ 10–15× projectile diameter"] -->
...
<!-- → [INFOGRAPHIC: two lunar surface patches drawn schematically side by side — left: unsaturated mare surface with scattered craters and visible basalt between them, crater density ~3/km²; right: saturated highland surface where craters overlap craters, earlier rims are destroyed by later impacts, nearly no original surface visible — annotate "saturation: new impacts destroy old craters as fast as they create new ones"; this is the visual concept that explains why crater counting stops working as a clock above a certain density] -->
...
<!-- → [DIAGRAM: giant impact sequence in four panels — (1) Theia (Mars-sized) on oblique collision course with early Earth; (2) oblique impact, both mantles partially vaporized, iron cores begin to merge; (3) debris ring of hot silicate material in orbit around Earth; (4) ring accumulates into the Moon over millions of years — annotate "iron sinks to cores before impact: mantles ejected, not cores" and "volatiles driven off by extreme heat in debris disk"] -->
...
<!-- → [TABLE: comparison of four lunar origin hypotheses — rows: fission, capture, sister formation, giant impact; columns: explains iron deficiency?, explains volatile loss?, explains oxygen isotope match with Earth?, dynamically stable?, verdict — the table structure makes the process-of-elimination argument visual and shows exactly why three hypotheses fail and one survives] -->
...
It is small: only 4,878 kilometers in diameter, less than half of Earth's. Its mass is about one-eighteenth of Earth's.
...
<!-- → [INFOGRAPHIC: interior cross-section comparison of Earth and Mercury drawn to the same scale — Earth: thin crust, thick silicate mantle, iron core ~32% of mass; Mercury: paper-thin silicate rind, iron core extending to 83% of planetary radius — the visual immediately communicates the anomaly that the rest of the section explains] -->
...
<!-- → [DIAGRAM: Mercury globe showing Caloris Basin (labeled, ~1,500 km diameter) on one hemisphere and the antipodal chaotic terrain on the opposite side — draw the seismic wave path traveling around the planet and converging at the antipode; annotate "waves arrive from all directions simultaneously, causing surface buckling" — this is one of the most striking causal relationships in planetary science and deserves its own visual] -->
...
<!-- → [IMAGE: MESSENGER high-resolution image of a Mercury lobate scarp — annotate its height (~1 km), length (hundreds of km), and the craters it cuts across (proving it post-dates the craters); caption: "Lobate scarps are compressional wrinkles — Mercury's surface crumpling as the planet slowly contracts under cooling"] -->
...
<!-- → [DIAGRAM: Mercury polar crater cross-section showing the cold trap mechanism — crater rim blocks sunlight from reaching the floor; exterior surface labeled ~430°C in direct sunlight; crater floor labeled ~-170°C in permanent shadow; water ice layer at the bottom labeled "preserved for billions of years"; annotate "geometry of the crater, not distance from the Sun, determines whether ice survives" — this is the key insight the visual must communicate] -->
...
**Crater counting as a clock.** A lunar surface has a crater density of 6 craters per square kilometer for craters 1 km or larger. Using the calibrated rate of 1 crater per square kilometer per 200,000 years, ask the model to calculate the estimated age of this surface. Then push the problem: if the surface is a mare, does this age make geological sense given what we know about when lunar volcanism occurred? Ask the model to identify what assumption in the calculation is most likely to introduce error, and why the same method would give unreliable results for surfaces older than 3.8 billion years.

**The circular crater puzzle.** Ask the model to explain why almost all impact craters are circular even when the projectile arrives at a shallow angle — say 15 degrees from horizontal. What would you expect from an ordinary low-speed collision at that angle? Why does hypervelocity change the result? Ask it to trace through the physics step by step: what happens in the first millisecond of impact, and at what point does the direction of the incoming projectile stop mattering?

**Eliminating the failed hypotheses.** Ask the model to walk through the three classical hypotheses for the Moon's origin — fission, capture, and sister formation — and identify the single most decisive piece of evidence that rules out each one. Then ask: if the oxygen isotope ratios of Moon rocks matched a completely different part of the solar system rather than Earth, which hypothesis would that evidence support? What would it rule out?

**Mercury's missing mantle.** Mercury is 60 percent iron by mass; Earth is about 32 percent. Ask the model to explain what this implies about Mercury's interior structure compared to Earth's. Then have it lay out both leading explanations for Mercury's iron enrichment — giant impact stripping vs. early solar evaporation — and identify what specific measurement or observation would allow scientists to distinguish between them. What data would BepiColombo need to collect?

**Ice on the innermost planet.** Ask the model to explain the mechanism that allows water ice to exist in permanently shadowed craters at Mercury's poles despite surface temperatures elsewhere exceeding 400 degrees Celsius. What does "cold trap" mean physically? Where did the water come from, and how was it preserved over billions of years? Then ask the model to predict whether the same mechanism could preserve ice in polar craters on the Moon, and whether this has been confirmed observationally.

**The saturation limit.** Ask the model to explain what happens to a planetary surface when it reaches crater saturation. Why doesn't the crater count keep increasing indefinitely? What does a saturated surface look like compared to an unsaturated one, and what does saturation tell you about the minimum age of the surface? Ask it to reason through why crater saturation means the highlands' true age cannot be derived from crater counts alone, and what additional method — used in this chapter — resolves the ambiguity.
