...
*What a stone that fell from the sky in 1969 tells us about events that happened before the Sun existed.*
...
<!-- → [INFOGRAPHIC: map of Antarctica showing the major meteorite concentration zones — label the Transantarctic Mountains ablation fields, the Yamato Mountains, and the Allan Hills; arrows showing ice flow direction from the interior toward the ablation zones; inset diagram showing the burial and transport mechanism: meteorite falls on ice sheet, gets buried, flows toward mountain barrier, ice ablates at surface exposing the stone] -->
...
<!-- → [IMAGE: three polished meteorite cross-sections side by side — left: iron meteorite showing Widmanstätten pattern (interlocking crystalline bands of nickel-iron, only visible in slowly cooled asteroid cores); center: carbonaceous chondrite showing dark matrix with chondrules (small round silicate spheres) embedded; right: stony-iron pallasite showing olivine crystals set in metallic matrix; each labeled with type and parent-body origin] -->
...
<!-- → [CHART: scatter plot of carbon isotope ratios (¹³C/¹²C on x-axis vs. ¹⁴N/¹⁵N on y-axis) for individual presolar grains from the Murchison meteorite — plot the solar system baseline as a crosshair; show clusters of grains offset far from the baseline labeled by stellar origin: AGB star carbon grains, supernova grains, nova grains; the visual purpose is to show how far the outlier grains sit from anything a solar-system process could produce] -->
...
<!-- → [CHART: exponential decay curve for uranium-238 — x-axis: time in billions of years (0 to 13), y-axis: fraction of original ²³⁸U remaining (0 to 1.0); mark the half-life at 4.468 Ga with a dashed vertical line where y = 0.5; mark the current age of the solar system (4.567 Ga) with a second dashed line; annotate the corresponding fraction of uranium remaining (~0.496) to show the measurement is in a well-calibrated range of the curve] -->
...
<!-- → [DIAGRAM: three-panel sequence of nebular collapse — panel 1: roughly spherical rotating gas cloud with spin-axis arrow; panel 2: intermediate flattening as collapse proceeds, material still falling inward at poles but spreading at equator; panel 3: final solar nebula with young Sun at center and thin disk extending outward, with a radial temperature gradient annotated (hot near Sun, cool at outer edge)] -->
...
<!-- → [INFOGRAPHIC: radial cross-section of the solar nebula from the Sun outward to ~35 AU — mark the condensation zones: (1) metals and refractory silicates (inside ~0.5 AU), (2) iron silicates (0.5–3 AU), (3) water ice added beyond the frost line (~3–4 AU, marked with dashed vertical line), (4) methane and ammonia ice (beyond ~10 AU); place the eight planets at their current orbital distances; annotate what materials were available to build each planet's core] -->
...
<!-- → [IMAGE: the ALMA millimeter-wavelength image of HL Tau's protoplanetary disk — the actual 2014 observation showing concentric bright rings separated by dark gaps; add a scale bar showing the orbital distances correspond to roughly 10–100 AU; annotate 2–3 of the most prominent gaps with labels indicating the approximate orbital distance of the implied protoplanet; include a small inset showing our own solar system to the same scale for comparison] -->
